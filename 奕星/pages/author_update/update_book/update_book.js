...
Page({
  ...
  onLoad: function (options) {
    ...
    //获取最新章节
    wx.request({
      url: 'http://localhost:8080/chapter',
      method: 'GET',
      data: {
        bid: obj[0].id
      },
  ...
  modify:function(e){
    ...
    if (!thiz.data.showss){
      ...
      wx.request({
         url: 'http://localhost:8080/author_update',
        method: 'GET',
        data: {
  ...
  imgupdate: function(e){
    ...
    wx.chooseImage({
      ...
      success: function (res) {
        ...
        wx.uploadFile({
          url: 'http://localhost:8080/updateimg?id=' + thiz.data.book.id + '&addr=' + thiz.data.book.addr + '&bookname=' + thiz.data.book.bookName +'',
